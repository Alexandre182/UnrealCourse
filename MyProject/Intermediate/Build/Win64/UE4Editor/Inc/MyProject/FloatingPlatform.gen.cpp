...
#include "MyProject/FloatingPlatform.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	MYPROJECT_API UClass* Z_Construct_UClass_AFloatingPlatform_NoRegister();
	MYPROJECT_API UClass* Z_Construct_UClass_AFloatingPlatform();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AFloatingPlatform_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_AFloatingPlatform_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_AFloatingPlatform_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AFloatingPlatform_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AFloatingPlatform, 2812097180);
	template<> MYPROJECT_API UClass* StaticClass<AFloatingPlatform>()
	{
		return AFloatingPlatform::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFloatingPlatform(Z_Construct_UClass_AFloatingPlatform, &AFloatingPlatform::StaticClass, TEXT("/Script/MyProject"), TEXT("AFloatingPlatform"), false, nullptr, nullptr, nullptr);
