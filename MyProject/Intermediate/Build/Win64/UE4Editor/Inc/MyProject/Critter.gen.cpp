...
// Cross Module References
	...
	MYPROJECT_API UClass* Z_Construct_UClass_ACritter();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ACritter_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ACritter_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_ACritter_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_ACritter_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ACritter, 369601308);
	template<> MYPROJECT_API UClass* StaticClass<ACritter>()
	{
		return ACritter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ACritter(Z_Construct_UClass_ACritter, &ACritter::StaticClass, TEXT("/Script/MyProject"), TEXT("ACritter"), false, nullptr, nullptr, nullptr);
